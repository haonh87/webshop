        ...
        <div class="container">
            <form action="{{ route('products.update', $productData->id) }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group col-sm-4 col-md-8">
                    ...
                    <input type="number" class="form-control" value="{{ $productData->sell_count }}" id="sell_count" name="sell_count" placeholder="Số sản phẩm" required>
                </div>
                ...
                <div class="form-group col-sm-4 col-md-8">
                    ...
                    {{ Form::select('product_color_ids[]', $productColors, explode(',', $productData->product_color_ids), ['class' => 'form-control selectpicker', 'id' => 'product_color_ids', 'multiple', 'title' => 'Chọn màu sắc']) }}
                </div>
