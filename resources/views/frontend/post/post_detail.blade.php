                        ...
                        <div class="cmsmasters_post_date_wrap"><span class="cmsmasters_post_date"><abbr
                            ...
                            <figure class="cmsmasters_img_wrap"><a
                                        ...
                                        class="cmsmasters_img_link"><img width="860" height="526"
                                                                         ...
                                                                         srcset="{{ asset($postDetail->image_url) }} 860w, {{ asset($postDetail->image_url) }} 300w, {{ asset($postDetail->image_url) }} 768w, {{ asset($postDetail->image_url) }} 1024w, {{ asset($postDetail->image_url) }} 600w, {{ asset($postDetail->image_url) }} 580w,{{ asset($postDetail->image_url) }} 1160w"
                                            ...
                                            <div class="cmsmasters_lpr_tabs_img">
                                                <figure class="cmsmasters_img_wrap"><a
                                                        ...
                                                        <img width="70" height="70"
                                                             ...
                                                             alt=" {{$post->title}}"
                                                             title=" {{$post->title}}"
                                                             srcset="{{ asset($post->image_url) }} 70w,{{ asset($post->image_url) }} 150w, {{ asset($post->image_url) }} 300w, {{ asset($post->image_url) }} 360w,{{ asset($post->image_url) }} 580w, {{ asset($post->image_url) }} 180w, {{ asset($post->image_url) }} 600w"
