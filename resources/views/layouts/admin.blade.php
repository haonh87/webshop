    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('categories.index')}}">MPMODA Admin</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="{{ route('products.index') }}"><i class="fa fa-fw fa-dashboard"></i>Product Management</a>
                    </li>
                    <li>
                        <a href="{{ action('Admin\CategoryController@index') }}"><i class="fa fa-fw fa-dashboard"></i>Category Management</a>
                    </li>
                    <li>
                        <a href="{{ action('Admin\VoteController@index') }}"><i class="fa fa-fw fa-dashboard"></i>Vote Management</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ action('Admin\UserController@index') }}"><i class="fa fa-fw fa-dashboard"></i>Account Management</a>
                    </li>
                    <li>
                        <a href="{{ action('Admin\CustomerController@index') }}"><i class="fa fa-fw fa-dashboard"></i>Customer Management</a>
                    </li>
                    @endif
                </ul>
            </div>
